...
local scheme = {
	root = {	'_opt_root_desc',
		...
		pocoRoseKey2 = {'key','n',nil,'_opt_pocoRoseKey2_desc'},
		...
		assumeNineLives = {'bool',FALSE,nil,'_opt_assumeNineLives_desc',nil,nil,1},
		replenished  = {'num',1,{0,4},'_opt_replenished_desc','ChatSend',nil,4},
		messiah  = {'num',5,{0,5},'_opt_messiah_desc','ChatSend',nil,5},
		specOps  = {'num',1,{0,5},'_opt_specOps_desc','ChatSend',nil,5},
		havePagers  = {'num',1,{0,5},'_opt_havePagers_desc','ChatSend',nil,5},
		haveCivilians  = {'num',1,{0,5},'_opt_haveCivilians_desc','ChatSend',nil,5},
...
local _vanity = {
	...
	language = {EN='English', DA='Dansk', DE='Deutsch', ES='Español', FR='Français',ID = 'Bahasa Indonesia', IT='Italiano',NL='Nederlands',NO='Norsk',PL='Polski',PT='Português (PT)',PT_BR='Português (BR)', RU='Русский', KR='한국어(KR)', CN_HK='繁體中文 (香港)(CN_HK)',CN='简体中文 (中国大陆)' },
}
----------------------------------------------------
